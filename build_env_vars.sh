...
# General
echo 'export DRT_TAG_PREFIX="gcr.io/distributed-ray-tracing"' >> env_vars.sh
echo 'export DRT_TAG_PREFIX_FOR_REPLACEMENT="gcr.io\/distributed-ray-tracing"' >> env_vars.sh
echo 'export DRT_TAG_VERSION="1.0"' >> env_vars.sh
echo 'export DRT_IMAGE_PULL_POLICY="Always"' >> env_vars.sh
echo 'export DRT_STATIC_IP=' >> env_vars.sh
...
# DRT ray tracing
echo 'export DRT_RAY_TRACING_NUMBER_OF_THREADS=4' >> env_vars.sh
